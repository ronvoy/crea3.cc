    ...
    <div className="grid gap-4">
        ...
        {PHASES.map((p, i) => (
          <Card key={p.titleKey} className="overflow-hidden">
            <div className="relative h-44">
              ...
              <span className="wf-badge absolute left-3 top-3 rounded-full bg-blue-600 px-2.5 py-1 text-xs font-semibold text-white shadow">
      ...
      <section className="flex flex-col items-start justify-between gap-3 rounded-[24px] border border-slate-200 bg-slate-50 p-6 shadow-sm sm:flex-row sm:items-center">
        ...
        <div className="flex gap-2">
          ...
          <Button component={Link} to="/scope" variant="outlined" color="inherit" sx={{ bgcolor: 'action.hover' }}>
            {t('landingNavScope')}
          </Button>
        </div>
      </section>
