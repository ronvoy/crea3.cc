...
export default function Partners() {
  ...
  return (
    <div className="grid gap-6">
        ...
        <div className="relative grid gap-8 p-6 text-white md:p-10 lg:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)]">
          <div className="lg:self-center">
            ...
            <p className="mt-3 max-w-md text-white/75">
              {t('partnersIntro', { cities: CITY_COUNT, countries: COUNTRY_COUNT })}
            </p>
      ...
      <section aria-label={t('partnersInstitutionsAria')} className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
